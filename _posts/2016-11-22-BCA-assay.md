...
We have 8 standards and 22 samples (with 3 replicates for each)and given each sample requires 200ul of working reagent.
...
6) Cover plate and incubate at 37C for 30 minutes

7) Cool plate to room temperature. Measure the absorbance at or near 562nm on plate reader.

8) Subtract the average 562nm absorbance measurement for teh Blank Standard Replicates from the 562nm measurements of all the other standard and sample replicates.
